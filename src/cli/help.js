...
export function printHelp({ stdout = process.stdout } = {}) {
  const lines = [
    ...
    "  aim codex run --tend [-p <profile>] [--resume <session-id>] [-- <codex args...>]  # run Codex TUI under an AIMGR PTY supervisor and tend goals across account rotation",
    ...
    "  --no-attach                      Start the PTY supervisor without attaching the current terminal.",
