...
export function printHelp({ stdout = process.stdout } = {}) {
  const lines = [
    ...
    "",
    "Notes:",
    "  - Shared SSOT: Redis at the configured Mac Studio primary, normally redis://amirs-mac-studio:6380.",
    ...
    "  --key-prefix <prefix>          Redis key prefix (default: aimgr:v1:).",
    "  --primary-host <host>          Human-readable Redis primary host, e.g. agents@amirs-mac-studio.",
    "  --transport <name>             Redis transport metadata, e.g. tailscale.",
    "  --machine <id>                 Machine id for `aim redis migrate collect`; must match ~/.aimgr/machine-id.",
    ...
    "  --confirm                      Required for Redis label/session repair commands.",
    ...
    "  -- <codex args...>                TEND owns Codex --remote; for `aim claude run`, args after -- pass to Claude.",
