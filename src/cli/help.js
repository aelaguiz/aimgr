...
export function printHelp({ stdout = process.stdout } = {}) {
  const lines = [
    ...
    "  aim prime resume <path-or-id> [--rotate]  # resume normally, or fork onto the next-best Codex account",
    ...
    "  - `aim prime resume <session> --rotate` clones saved context into a new root and rebinds only Codex; plain resume stays pinned.",
